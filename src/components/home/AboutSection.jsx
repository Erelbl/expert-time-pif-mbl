...
const features = [
  {
    ...
    description: "בכל מחזור, 4 בוגרים בעלי ניסיון וידע ייחודי מתנדבים לשתף את הקהילה"
  },
  {
    icon: Clock,
    title: "4 שעות התנדבות",
    description: "כל מומחה מעניק 4 שעות ייעוץ אישי לחברי הקהילה לאורך המחזור"
  },
  {
    icon: Lightbulb,
    title: "ייעוץ מקצועי",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Expert Time הוא מיזם ייחודי של קהילת בוגרי הופמן קופמן, שמאפשר לבוגרים
            בעלי מומחיות לתרום מזמנם וידעם לטובת חברי הקהילה. כל חודשיים, 4 מומחים
            נבחרים מעניקים שעות ייעוץ בתחומי התמחותם.
          </p>
        </motion.div>
